...
public class SpriteMerger
{
    ...
    public static Texture2D InsertTextureWithOffset(Texture2D original,Texture2D textureToInsert,Vector2 offset,SpriteRenderer targetRenderer = null)
    {
    ...
    public static Texture2D InsertMask(Texture2D original,Texture2D textureToInsert,Vector2 offset,SpriteRenderer targetRenderer = null)
    {
        var newTexture = new Texture2D(original.width,original.height);
